...
suppressWarnings({
  ...
  data1<-data[c("Q6","Q23", "Q37", "Q38", "Q39", "Q40", "Q42", "Q43", "Q44", "Q45", "Q46", "Q47", "Q48", "Q49", "Q50", "Q112", "Q113", "Q114", "Q115", "Q116", "Q117", "Q118", "Q119", "Q120", "Q121", "Q122", "Q123", "Q126", "Q127", "Q128", "Q129", "Q130", "Q131")]
DataNN<-data1%>%setNames(c("AGE", "Gameyears", "GDT1", "GDT2", "GDT3", "GDT4", "IGD1", "IGD2", "IGD3", "IGD4", "IGD5", "IGD6", "IGD7", "IGD8", "IGD9", "ID1", "ID2", "ID3", "ID4", "IM1", "IM2", "IM3", "IM4", "IM5", "COMP1", "COMP2", "COMP3", "PE1", "PE2", "PE3", "PE4", "PE5", "PE6"))
...
DATAAIGD<-DataM[c("AGE", "Gameyears","GDTTotal", "IDTotal", "IMTotal", "COMPTotal", "PETotal")]
DATAAIIGD<-DataM[c("AGE", "Gameyears","IGDTTotal", "IDTotal", "IMTotal", "COMPTotal", "PETotal")]
...
IGDD<-IGDD %>% 
  mutate(IGDTTotal = case_when(IGDTTotal == 1 ~ "Yes",
                             IGDTTotal == 0 ~ "No"))
  GDTDiag<-GDTD%>%setNames(c("AGE", "Gameyears","GDDiag", "IDTotal", "IMTotal", "COMPTotal", "PETotal")) 
  IGDDiag<-IGDD%>%setNames(c("AGE", "Gameyears","IGDDiag", "IDTotal", "IMTotal", "COMPTotal", "PETotal"))
