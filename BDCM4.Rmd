...
DATAAIGD<-DataM[c("AGE", "GDTTotal", "IDTotal", "IMTotal", "COMPTotal")]
DATAAIIGD<-DataM[c("AGE", "IGDTTotal", "IDTotal", "IMTotal", "COMPTotal")]
...
IGDD<-IGDD %>% 
  mutate(IGDTTotal = case_when(IGDTTotal == 1 ~ "Yes",
                             IGDTTotal == 0 ~ "No"))
  GDTDiag<-GDTD%>%setNames(c("Age", "GDDiag", "IDTotal", "IMTotal", "COMPTotal")) 
  IGDDiag<-IGDD%>%setNames(c("Age", "IGDDiag", "IDTotal", "IMTotal", "COMPTotal"))
