...
DATAAIGD<-DataM[c("Gameyears","GDTTotal", "IDTotal", "IMTotal", "COMPTotal")]
DATAAIIGD<-DataM[c("Gameyears","IGDTTotal", "IDTotal", "IMTotal", "COMPTotal")]
...
IGDD<-IGDD %>% 
  mutate(IGDTTotal = case_when(IGDTTotal == 1 ~ "Yes",
                             IGDTTotal == 0 ~ "No"))
  GDTDiag<-GDTD%>%setNames(c("Gameyears","GDDiag", "IDTotal", "IMTotal", "COMPTotal")) 
  IGDDiag<-IGDD%>%setNames(c("Gameyears","IGDDiag", "IDTotal", "IMTotal", "COMPTotal"))
